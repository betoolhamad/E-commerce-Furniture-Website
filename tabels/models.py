...
class ItemsTabels(models.Model): #هذا جدول اسمه العناصر
...
class ItemDetailsTabels(models.Model): #هذا جدول اسمه تفاصيل العناصر
    ...
    itemid=models.ForeignKey(ItemsTabels,on_delete=models.CASCADE) #هنا قلنا ان الاي دي بالجدول الاول يعتبر فورن كي بالجدول الثاني .. 
